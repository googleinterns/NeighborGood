  ...
  <body onload="showNeedHelp()">
    ...
    <div id="task-list">
        ...
        <table id="offer-help">
            ...
            <tr>
                <td>Collect the garbage on the drive</td>
                <td>Leonard</td>
                <td>100 pts</td>
				<td><button class="complete-task" onclick="completeTask(this)">
                    <i class="fa fa-check"></i>
                </button></td>
                <td><button class="abandon-task" onclick="completeTask(this)">	
                    <i class="fa fa-times"></i>	
                </button></td>
            </tr>
            <tr>
                <td>Mown the grass in the backyard</td>
                <td>Jack</td>
                <td>150 pts</td>
                <td><button class="complete-task" onclick="completeTask(this)">
                    <i class="fa fa-check"></i>
            ...
            <tr>
                <td>Help me grab some bread and milk from supermarket</td>
                <td>Jason</td>
                <td>250 pts</td>
                <td><button class="complete-task" onclick="completeTask(this)">
                    <i class="fa fa-check"></i>
    ...
    <div id="editTaskModal">
        <div id="editModal">
            <span id="edit-close-button" onclick="closeEditModal()">&times;</span>
            <form id="edit-task-form" action="/tasks/edit" method="POST">
                <h1>EDIT THE CURRENT TASK: </h1>
                <div>
                    <label for="edit-content-input">Task Detail:</label>
                    <br/>
                </div>
                <textarea name="edit-content-input" id="edit-content-input"></textarea>
                <br/>
                <label for="edit-point-input">Rewarding Points: </label>
                <input type="number" id="edit-point-input" name="edit-input" min="0" max="200">
                <textarea name="task-id" id="task-id-input"></textarea>
                <br/>
                <br/>
                <input type="submit" />
            </form>
